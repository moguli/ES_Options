...
#define ASSET 				"SPX500"
#define HISTORY			".t6"	// historical data file
#define STARTDATE			20190420
#define ENDDATE			20190420	
#define BARPERIOD 		1440
#define EXPIRY				1*7	// in days
#define RANGE				0.02	// plot price range, percentage
#define DIVIDEND			0.01
#define RISKFREE			0.01
#define UNDERL				3000	// if no asset
...
void doCombo() 
{
	Strangle(); // <= put here the combo to test
	//Butterfly();
}
